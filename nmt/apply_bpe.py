...
class apply_bpe():
    def __init__(self, codes_file_path, vocabulary_file_path, separator='@@'):
        codes = codecs.open(codes_file_path, encoding='utf-8')
        vocabulary_file_path = codecs.open(vocabulary_file_path, encoding='utf-8')
        if vocabulary_file_path:
            vocabulary = read_vocabulary(vocabulary_file_path, None)
        else:
            vocabulary = None
        self.bpe = BPE(codes, separator, vocabulary)
